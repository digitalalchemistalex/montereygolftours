...
export default function CourseHotels({ courseSlug, courseName }: Props) {
  ...
  return (
    <section style={{ borderTop: "0.5px solid #D3D1C7", padding: "3.5rem 0" }}>
      <p style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", color: "#888780", fontWeight: 500, marginBottom: 6 }}>
        {courseName}
      </p>
      <h2 style={{ fontSize: 22, fontWeight: 500, color: "#2C2C2A", marginBottom: "1.25rem" }}>
        Closest hotels
      </h2>
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        {hotels.map((h) => {
          ...
          return (
            ...
            >
              <div>
                <div style={{ fontSize: 14, fontWeight: 500, color: "#2C2C2A", marginBottom: 3, display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
                  {h.hotelName}
                  <span style={{ fontSize: 10, fontWeight: 500, padding: "2px 8px", borderRadius: 20, background: badge.bg, color: badge.text }}>
                    {badge.label}
                  </span>
                </div>
              ...
              <div style={{ textAlign: "right", flexShrink: 0 }}>
                <div style={{ fontSize: 22, fontWeight: 500, lineHeight: 1, color: isFar ? "#B4B2A9" : "#042C53" }}>
