  ...
  return (
    <header className={
      !isFixed
        ...
        : "fixed top-0 left-0 right-0 z-50 flex items-center justify-between border-b border-[#e8e2d3] bg-cream/97 px-5 py-2 shadow-[0_2px_12px_rgba(37,35,33,.08)] backdrop-blur-md lg:py-2 md:px-10"
    }>
