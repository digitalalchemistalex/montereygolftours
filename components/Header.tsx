          ...
          <div className={`${DROP} left-1/2 w-[560px] -translate-x-1/2`}>
            <div className={`${CARD} grid grid-cols-2`}>
              ...
              <div className="col-span-2 flex items-center justify-between border-t border-[#f0ebe1] bg-[#fdfbf7] px-4 py-2.5">
                ...
                <a href="https://www.pebblebeach.com/plan-your-visit/" target="_blank" rel="noopener noreferrer" className="font-ui text-[11.5px] font-semibold text-ocean hover:underline">PBR Experiences →</a>
              </div>
            </div>
          </div>
        </div>
