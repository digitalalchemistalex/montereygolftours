  ...
  return (
    <header className={
      !isFixed
        ...
        : "fixed top-0 left-0 right-0 z-50 grid grid-cols-[44px_1fr_44px] items-center gap-4 border-b border-[#e8e2d3] bg-cream/97 px-5 py-2 shadow-[0_2px_12px_rgba(37,35,33,.08)] backdrop-blur-md lg:flex lg:justify-between lg:py-2 md:px-10"
    }>
      ...
      <Link href="/" className="col-start-2 flex flex-none items-center justify-center lg:col-auto lg:justify-start">
        {isFixed && <Logo size={60} className="lg:hidden" />}
        {isFixed && <Logo size={72} className="hidden lg:flex" />}
      </Link>
          ...
          <div className={`${DROP} left-1/2 w-[560px] -translate-x-1/2`}>
            <div className={`${CARD} grid grid-cols-2`}>
              ...
              <div className="col-span-2 flex items-center justify-between border-t border-[#f0ebe1] bg-[#fdfbf7] px-4 py-2.5">
                ...
                <a href="https://www.pebblebeach.com/golf/experiences/" target="_blank" rel="noopener noreferrer" className="font-ui text-[11.5px] font-semibold text-ocean hover:underline">PBR Experiences →</a>
              </div>
            </div>
          </div>
        </div>
