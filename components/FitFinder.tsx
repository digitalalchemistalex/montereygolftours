  ...
  return (
    <section className="border-b border-[#eceae1] px-6 py-16 md:px-14 md:py-24">
      ...
      <div className="grid grid-cols-2 gap-8 sm:gap-10 md:grid-cols-4">
        {FIT_PROFILES.map((f) => (
          <Link key={f.title} href="/quote/" className="group flex flex-col items-center text-center">
            <div className="relative aspect-square w-full max-w-[190px] overflow-hidden rounded-full shadow-[0_8px_24px_rgba(30,40,38,.18)] transition-transform duration-200 group-hover:-translate-y-1.5 group-hover:shadow-[0_16px_36px_rgba(30,40,38,.28)]">
              <Image
                src={f.img}
                alt={f.title}
                fill
