...
// Updated: logo path fixed to /brand/logo-transparent-master.png, circular 72px
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td style="vertical-align:middle">
          ...
          <div style="color:#C9A24D;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;margin-top:3px">Pebble Beach &middot; Carmel &middot; Monterey Peninsula</div>
        </td>
      </tr>
    </table>
  </div>
