...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!exp) return {};
  return {
    title: `${exp.name.includes("Pebble Beach") ? exp.name : `${exp.name} at Pebble Beach`} | Monterey Golf Tours`,
    ...
    twitter: { card: "summary_large_image", title: `${exp.name.includes("Pebble Beach") ? exp.name : `${exp.name} at Pebble Beach`} | Monterey Golf Tours` },
  };
}
