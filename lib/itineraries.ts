...
export const ITINERARIES: Record<string, ItineraryTemplate> = {
  "3-day-monterey-golf-weekend": {
    ...
    durationDays: 3,
    rounds: "3 rounds",
    target: "Casual golfer group, weekend escape",
  ...
  "4-day-monterey-peninsula-golf-trip": {
    ...
    durationDays: 4,
    rounds: "4 rounds",
    target: "Serious golfer group, bucket-list trip",
  ...
  "5-day-complete-monterey-golf-vacation": {
    ...
    durationDays: 5,
    rounds: "5 rounds",
    target: "Avid golfer group wanting to play every key course",
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          "Afternoon: optional round at TPC Monterey at Pasadera if available",
  ...
  "7-day-ultimate-monterey-golf-trip": {
    ...
    durationDays: 7,
    rounds: "6–7 rounds",
    target: "Golf enthusiast wanting everything",
    ...
    days: [
      {
        ...
        items: [
          "Arrive at MRY — drop bags at Carmel Valley Ranch",
          "Afternoon: Carmel Valley Ranch on-site course (Pete Dye design)",
          "Check in after the round",
          "Evening: dinner at Valley Kitchen",
        ],
      },
      {
        day: 2,
        title: "TPC Monterey at Pasadera + wine",
        items: [
          "Morning: TPC Monterey at Pasadera (Monday public access — confirm availability in advance)",
    ...
    faqs: [
      ...
      { q: "Does this trip include TPC Monterey at Pasadera?", a: "Yes, alongside wine tasting on the same day, given the Carmel Valley base for the first stretch of the trip." },
    ...
    days: [
      {
        ...
        title: "Arrival + Carmel Valley Ranch",
        items: [
          "Arrive — drop bags at Carmel Valley Ranch",
  ...
  "pebble-beach-golf-package": {
    ...
    durationDays: 4,
    rounds: "4 rounds",
    target: "Serious golfers making their Pebble Beach bucket-list trip",
  ...
  "monterey-corporate-golf-outing": {
    ...
    durationDays: 2,
    rounds: "1–2 rounds",
    target: "Corporate groups, client events, team building, incentive trips",
  ...
  "monterey-golf-trip-best-value": {
    ...
    durationDays: 3,
    rounds: "3 rounds",
    target: "Budget-conscious golfer group",
