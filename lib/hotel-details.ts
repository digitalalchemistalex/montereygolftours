...
export const HOTEL_DETAILS: Record<string, HotelDetail> = {
  ...
  "lodge-at-pebble-beach": {
    ...
    amenities: [
      ...
      "The Beach & Tennis Club™ and The Spanish Bay Club™ — complimentary daily access for all guests of The Lodge, Inn, and Casa Palmero",
  ...
  "casa-palmero": {
    ...
    diningNames: [
      ...
      { name: "Access to all Lodge and Inn dining", detail: "Stillwater™, The Tap Room™, The Bench™, Peppoli at Pebble Beach™, STAVE Wine Cellar at Spanish Bay™ — courtesy shuttle or short drive" },
    ],
    onSiteGolf: "Pebble Beach Golf Links®",
    airportDistance: "~15 min from MRY (Monterey Regional Airport)",
    driveTimeToCourses: [
