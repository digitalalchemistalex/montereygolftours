...
export const HOTEL_DETAILS: Record<string, HotelDetail> = {
  ...
  "lodge-at-pebble-beach": {
    ...
    gallery: [
      ...
      { src: "/images/pbc-portal/lodge_2025_lobby.jpg", alt: "The Lodge at Pebble Beach™ ocean-view dining room, Pebble Beach, CA — floor-to-ceiling windows overlooking Stillwater Cove", caption: "The Lodge at Pebble Beach™ lobby — classic California coastal elegance at the heart of Pebble Beach Resorts®.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2025, category: "Lobby", tag: "Lobby", location: "Pebble Beach, CA" },
