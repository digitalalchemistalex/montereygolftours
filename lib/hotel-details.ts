...
export const HOTEL_DETAILS: Record<string, HotelDetail> = {
  "hyatt-regency-monterey": {
    ...
    faqs: [
      ...
      { q: "Can I book the Hyatt Regency Monterey as part of a Monterey golf package?", a: "Yes. Monterey Golf Tours includes the Hyatt Regency Monterey in Monterey golf packages — centrally located for groups playing Bayonet, Black Horse, Laguna Seca, and Pacific Grove, with shuttle access to the Pebble Beach courses. A good base for groups who want a full-service hotel at a non-resort rate." },],
  },
  "carmel-valley-ranch": {
  ...
  "monterey-plaza": {
    ...
    faqs: [
      ...
      { q: "Is Monterey Plaza Hotel a good choice for a Monterey golf trip?", a: "Yes. Monterey Plaza Hotel sits on Cannery Row with direct Monterey Bay views and is centrally located for groups playing Bayonet, Black Horse, Laguna Seca, Pacific Grove, and Del Monte. Monterey Golf Tours includes it in Monterey golf packages for groups who want a downtown location with easy course access." },],
  },
  "intercontinental-the-clement": {
    ...
    faqs: [
      ...
      { q: "Can InterContinental The Clement be included in a Monterey golf package?", a: "Yes. InterContinental The Clement Monterey is on Cannery Row with Monterey Bay views, well-positioned for groups playing the non-Pebble Beach courses on the peninsula. Monterey Golf Tours includes it as a downtown base with easy access to Bayonet, Black Horse, Laguna Seca, and Pacific Grove." },],
  },
  "portola-hotel": {
    slug: "portola-hotel",
  ...
  "embassy-suites-monterey-bay-seaside": {
    ...
    faqs: [
      ...
      { q: "Is Embassy Suites Monterey Bay a good base for a golf trip?", a: "Yes. Embassy Suites Monterey Bay is adjacent to Bayonet and Black Horse at former Fort Ord, making it the closest hotel to those two courses. Monterey Golf Tours includes it in Fort Ord-focused golf packages and in budget-conscious Monterey golf trips where groups want walk-to-the-first-tee convenience." },],
  },
  "monterey-beach-hotel": {
    ...
    faqs: [
      ...
      { q: "Can Monterey Beach Hotel be included in a Monterey golf package?", a: "Yes. Monterey Beach Hotel is a solid value option for Monterey golf trips — oceanfront, close to Pacific Grove Golf Links and Laguna Seca, and at a price point that leaves more of the budget for green fees. Monterey Golf Tours includes it in packages for groups who want an ocean-facing hotel without the full resort rate." },],
  },
  ...
  "lodge-at-pebble-beach": {
    ...
    gallery: [
      ...
      { src: "/images/pbc-portal/lodge_2017_interior_fairwayone_cottage.jpg", alt: "Fairway One Cottage great room at The Lodge at Pebble Beach™, Pebble Beach, CA — vaulted ceiling, stone fireplace, and golf course views", caption: "Fairway One Cottage at The Lodge at Pebble Beach™ — the Palmer and Eastwood Cottages sit directly on the first fairway, steps from the first tee.", credit: "Photo by Noah Webb", photographer: "Noah Webb", year: 2017, category: "Guest Rooms", tag: "Fairway One Cottage", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/lodge_2018_interior_oceanstudio.jpg", alt: "Ocean Studio guest room at The Lodge at Pebble Beach™, Pebble Beach, CA — Pacific views", caption: "An Ocean Studio at The Lodge at Pebble Beach™ — rooms range from 570 to 1,300 sq ft with garden, fairway, or Pacific views.", credit: "Photo by Noah Webb", photographer: "Noah Webb", year: 2018, category: "Guest Rooms", tag: "Ocean Studio", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/fairway-one-cottage.jpg", alt: "Fairway One guest room interior at The Lodge at Pebble Beach™, Pebble Beach, CA — king bed with direct golf course view", caption: "Fairway One at The Lodge at Pebble Beach™ — 30 oversized guest rooms in three two-story buildings directly on the first fairway.", credit: "Photo by Noah Webb", photographer: "Noah Webb", year: 0, category: "Guest Rooms", tag: "Fairway One", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/fairwayone_2017_exterior_cottage.jpg", alt: "Fairway One Cottage exterior at The Lodge at Pebble Beach™, Pebble Beach, CA — Palmer and Eastwood Cottages", caption: "The exterior of Fairway One Cottage at The Lodge at Pebble Beach™ — the Palmer and Eastwood Cottages each sleep four, with a shared great room and fire pit on the first fairway.", credit: "Photo by Noah Webb", photographer: "Noah Webb", year: 2017, category: "Exterior", tag: "Fairway One · Exterior", location: "Pebble Beach, CA" },
    ],
    description: [
      ...
      "As a Lodge guest, tee times at Pebble Beach Golf Links® and all Pebble Beach Resorts® courses can be booked up to 18 months in advance — the earliest booking window available at the resort. Access to The Beach & Tennis Club™ and The Spanish Bay Club™, and a complimentary Lexus test drive are all included in the stay. Guests wishing to use The Spa at Pebble Beach™ (22,000 square feet, Forbes Five-Star) can book a day pass or spa service.",
    ...
    amenities: [
      ...
      "The Beach & Tennis Club™ and The Spanish Bay Club™ — complimentary daily access for all guests of The Lodge, Inn, and Casa Palmero (accessible via courtesy shuttle)",
    ...
    diningNames: [
      { name: "Stillwater™", detail: "Oceanfront dining on Carmel Bay — seafood and California cuisine" },
      { name: "The Tap Room™", detail: "Casual bar and grill with views of the 18th hole" },
      { name: "The Bench™", detail: "Restaurant at The Lodge at Pebble Beach™ — contemporary California cuisine" },
      { name: "The Terrace Lounge™", detail: "Located in the lobby of The Lodge" },
      { name: "The Gallery Café™", detail: "Located at The Lodge above the retail shops" },
      { name: "Hay's Place™", detail: "Located at The Hay course near The Lodge and Pebble Beach Golf Links®" },
    ],
  ...
  "inn-at-spanish-bay": {
    ...
    gallery: [
      ...
      { src: "/images/pbc-portal/the-inn-at-spanish-bay---fire-pits.jpg", alt: "Fire pits at The Inn at Spanish Bay™, Pebble Beach, CA — evening gathering spot overlooking the Pacific", caption: "The fire pits at The Inn at Spanish Bay™ — each evening a bagpiper plays on the 18th green as the sun sets over the Pacific.", credit: "Photo by Joann Dost", photographer: "Joann Dost", year: 0, category: "Exterior", tag: "Fire pits", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/inn_2018_executiveforestsuite.jpg", alt: "Executive Forest Suite at The Inn at Spanish Bay™, Pebble Beach, CA — views into Del Monte Forest", caption: "The Executive Forest Suite at The Inn at Spanish Bay™ — the forest-facing room category with views into the Del Monte Forest pines.", credit: "Photo by Sherman Chu", photographer: "Sherman Chu", year: 2018, category: "Suites", tag: "Executive Forest Suite", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/the-inn-spanish-bay-suite.jpg", alt: "Spanish Bay Suite formal dining room at The Inn at Spanish Bay™, Pebble Beach, CA — 10-seat private dining table", caption: "The Spanish Bay Suite at The Inn at Spanish Bay™ — formal private dining room with a 10-seat table, part of the premier suite.", credit: "Photo by Sherman Chu", photographer: "Sherman Chu", year: 0, category: "Suites", tag: "Spanish Bay Suite", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/the-inn-spanish-bay-suite-1.jpg", alt: "Spanish Bay Suite interior at The Inn at Spanish Bay™, Pebble Beach, CA — coastal California design", caption: "The Spanish Bay Suite at The Inn at Spanish Bay™ — spacious interiors with the signature coastal California design palette.", credit: "Photo by Sherman Chu", photographer: "Sherman Chu", year: 0, category: "Suites", tag: "Spanish Bay Suite", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/the-inn-at-spanish-bay-guest-rooms.jpg", alt: "Standard guest room at The Inn at Spanish Bay™, Pebble Beach, CA — king bed, gas fireplace, and balcony", caption: "Guest rooms at The Inn at Spanish Bay™ — all rooms feature gas fireplaces and most have private patios or balconies.", credit: "© Pebble Beach Company", photographer: "Pebble Beach Company", year: 0, category: "Guest Rooms", tag: "Guest rooms", location: "Pebble Beach, CA" },
      { src: "/images/pbc-portal/spanish-bay-bagpiper.jpg", alt: "Spanish Bay bagpiper at The Inn at Spanish Bay™, Pebble Beach, CA — Scottish piper at sunset", caption: "The Spanish Bay bagpiper at The Inn at Spanish Bay™ — a Scottish piper plays every evening at sunset from the first tee to the fire pits.", credit: "Photo by Sherman Chu", photographer: "Sherman Chu", year: 0, category: "Exterior", tag: "Bagpiper · Sunset", location: "Pebble Beach, CA" },
    ],
    description: [
      "The Inn at Spanish Bay™ sits at the northern end of the 17-Mile Drive, where the Del Monte Forest meets the Pacific coastline. Every guest room features a gas-burning fireplace and, in most cases, a private patio or balcony overlooking the forest, fairways, or open ocean. Rooms range from 470 to 2,100 square feet — the Spanish Bay Suite offers a dining/conference table for 10 and a grand piano.",
      ...
      "The Inn at Spanish Bay™ is the natural base for Monterey golf packages that prioritise the Links at Spanish Bay® and Spyglass Hill® — both accessible on foot or by a short shuttle. Monterey Golf Tours books The Inn as part of IAGTO Pebble Beach packages, typically for groups who prefer the Spanish Bay setting.",],
    amenities: [
      ...
      "The Spanish Bay Club™ & Tennis Pavilion — complimentary daily access for all guests of The Lodge, Inn, and Casa Palmero",
      "STAVE Wine Cellar at Spanish Bay™ — wine lounge and shop on-site",
      "Seaside boardwalk with hidden coves and sandy beaches",
      "The Spa at Pebble Beach™ — shared with The Lodge and Casa Palmero (15 min courtesy shuttle); day pass or spa service required for Lodge and Inn guests",
      "The Beach & Tennis Club™ — complimentary daily access for all guests of The Lodge, Inn, and Casa Palmero (accessible via courtesy shuttle)",
    ...
    roomFeatures: [
      ...
      "Two microfibre robes and slippers",
      "Spanish Bay Suite: 2,100 sq ft, dining table seats 10, grand piano, conference capabilities",
    ],
    uniqueDetails: [
      ...
      "STAVE Wine Cellar at Spanish Bay™ — a wine lounge and shop on-site",
    ],
    diningNames: [
      { name: "STICKS™", detail: "Casual all-day dining on the links — views of the 1st fairway of The Links at Spanish Bay®" },
      { name: "Peppoli at Pebble Beach™", detail: "Tuscan-inspired fine dining — fireplace and forest terrace" },
      { name: "Traps™", detail: "On-site dining at The Inn at Spanish Bay™" },
      { name: "STAVE Wine Cellar at Spanish Bay™", detail: "Wine lounge and shop — Monterey-focused selections" },
    ],
  ...
  "casa-palmero": {
    ...
    amenities: [
      ...
      "The Spa at Pebble Beach™ — complimentary daily access for Casa Palmero guests (Forbes Five-Star; steps away)",
      "The Beach & Tennis Club™ — complimentary daily access for all guests of The Lodge, Inn, and Casa Palmero (accessible via courtesy shuttle)",
      "Complimentary daytime rides into Carmel-by-the-Sea",
      "Exclusive wellness classes",
      "Complimentary evening cordials and dessert reception — exclusive to Casa Palmero guests",
    ...
    diningNames: [
      { name: "Casa Palmero Bar & Lounge", detail: "Private guest receptions only — complimentary evening happy hour and cordials after dinner. Not a public bar or lounge." },
      { name: "In-room dining", detail: "24-hour healthful room service menu" },
      { name: "Access to all Lodge and Inn dining", detail: "Lodge: Stillwater™, The Tap Room™, The Bench™, The Terrace Lounge™, The Gallery Café™, Hay's Place™ · Inn: Peppoli at Pebble Beach™, STICKS™, Traps™, STAVE Wine Cellar at Spanish Bay™ — courtesy shuttle or short drive" },
    ],
    onSiteGolf: "Pebble Beach Golf Links®",
    airportDistance: "~15 min from MRY (Monterey Regional Airport)",
    driveTimeToCourses: [
    ...
    gallery: [
      { src: "/images/pbc-portal/cp_2024_exterior_fountain.jpg", alt: "Casa Palmero™ garden walkway with fountain, Pebble Beach, CA — stone path through manicured gardens", caption: "The courtyard fountain at Casa Palmero™ — the heart of the Mediterranean-style estate.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Exterior & Pool", tag: "Courtyard" },
      { src: "/images/pbc-portal/cp_2024_exterior_pool.jpg", alt: "Casa Palmero™ heated outdoor pool, Pebble Beach, CA", caption: "The heated outdoor pool at Casa Palmero™ — available exclusively to estate guests.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Exterior & Pool", tag: "Pool" },
      { src: "/images/pbc-portal/cp_2024_exterior_palmerosuite_patio.jpg", alt: "Casa Palmero™ Palmero Suite private patio, Pebble Beach, CA", caption: "The private patio of the Palmero Suite at Casa Palmero™ — 1,500 sq ft opening onto the estate courtyard.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Exterior & Pool", tag: "Palmero Suite Patio" },
      { src: "/images/pbc-portal/cp_2024_exterior_sparoom_patio.jpg", alt: "Casa Palmero™ Spa Room private outdoor whirlpool patio, Pebble Beach, CA", caption: "The private garden patio with outdoor whirlpool spa on a Spa Room at Casa Palmero™.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Exterior & Pool", tag: "Spa Room Patio" },
      { src: "/images/pbc-portal/cp_2024_exterior_sparoom_patio-1.jpg", alt: "Casa Palmero™ Spa Room patio with outdoor spa, Pebble Beach, CA", caption: "Spa Room private patio at Casa Palmero™ — each Spa Room opens directly onto a garden patio with a private outdoor whirlpool.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Exterior & Pool", tag: "Spa Room Patio" },
      { src: "/images/pbc-portal/cp_2024_interior_livingroom.jpg", alt: "Casa Palmero™ main house living room, Pebble Beach, CA", caption: "The main house living room at Casa Palmero™ — available exclusively to estate guests.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Living Spaces", tag: "Living Room" },
      { src: "/images/pbc-portal/cp_2024_interior_livingroom-1.jpg", alt: "Casa Palmero™ living room interior, Pebble Beach, CA", caption: "The estate living room at Casa Palmero™ — wood-beamed ceilings and fireplace throughout the main house.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Living Spaces", tag: "Living Room" },
      { src: "/images/pbc-portal/cp_2024_interior_billiardsroom.jpg", alt: "Casa Palmero™ billiards room, Pebble Beach, CA", caption: "The billiards room at Casa Palmero™ — one of the exclusive-use facilities in the main house.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Living Spaces", tag: "Billiards Room" },
      { src: "/images/pbc-portal/cp_2024_interior_bar.jpg", alt: "Casa Palmero™ fireside lounge, Pebble Beach, CA — intimate seating area with fireplace", caption: "The bar and lounge at Casa Palmero™ — evening wine flights and cocktails for estate guests only.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Living Spaces", tag: "Bar & Lounge" },
      { src: "/images/pbc-portal/cp_2024_interior_bar-1.jpg", alt: "Casa Palmero™ private bar at Pebble Beach, CA — full-service bar with back-lit spirits display", caption: "The Casa Palmero™ bar — complimentary cocktails each evening are a signature of the estate experience.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Living Spaces", tag: "Bar & Lounge" },
      { src: "/images/pbc-portal/cp_2024_interior_estateroom.jpg", alt: "Casa Palmero™ Estate Room with en-suite soaking tub and fireplace, Pebble Beach, CA", caption: "An Estate Room at Casa Palmero™ — open wood-beamed ceilings, gas fireplace, and oversized soaking tub.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Estate Rooms", tag: "Estate Room" },
      { src: "/images/pbc-portal/cp_2024_interior_estateroom-1.jpg", alt: "Casa Palmero™ Estate Room with fireplace, Pebble Beach, CA", caption: "Estate Room at Casa Palmero™ — every room includes a gas fireplace and fairway or garden views.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Estate Rooms", tag: "Estate Room" },
      { src: "/images/pbc-portal/cp_2024_interior_estateroom_doublequeen.jpg", alt: "Casa Palmero™ Estate Room double queen configuration, Pebble Beach, CA", caption: "An Estate Room configured with two queen beds at Casa Palmero™.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Estate Rooms", tag: "Estate Room" },
      { src: "/images/pbc-portal/cp_2024_interior_bathroom.jpg", alt: "Casa Palmero™ Estate Room bathroom, Pebble Beach, CA", caption: "The bathroom in an Estate Room at Casa Palmero™ — oversized soaking tub with The Spa Collection bath amenities.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Estate Rooms", tag: "Bathroom" },
      { src: "/images/pbc-portal/cp_2024_interior_bathroom-1.jpg", alt: "Casa Palmero™ Estate Room soaking tub, Pebble Beach, CA", caption: "Soaking tub with garden views in an Estate Room at Casa Palmero™ — private, tranquil, and steps from the courtyard.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Estate Rooms", tag: "Bathroom" },
      { src: "/images/pbc-portal/cp_2024_interior_bathroom_ada.jpg", alt: "Casa Palmero™ ADA accessible bathroom, Pebble Beach, CA", caption: "An ADA accessible bathroom at Casa Palmero™.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Estate Rooms", tag: "ADA Room" },
      { src: "/images/pbc-portal/cp_2024_interior_sparoom_king.jpg", alt: "Casa Palmero™ Spa Room king bedroom, Pebble Beach, CA", caption: "A Spa Room king bedroom at Casa Palmero™ — ground-floor rooms opening directly onto a private garden patio with outdoor whirlpool.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Spa Rooms", tag: "Spa Room" },
      { src: "/images/pbc-portal/cp_2024_interior_sparoom_doublequeen.jpg", alt: "Casa Palmero™ Spa Room double queen bedroom, Pebble Beach, CA", caption: "A Spa Room with double queen beds at Casa Palmero™ — private patio with outdoor whirlpool spa.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Spa Rooms", tag: "Spa Room" },
      { src: "/images/pbc-portal/cp_2024_interior_sparoom_bathroom.jpg", alt: "Casa Palmero™ Spa Room bathroom, Pebble Beach, CA", caption: "The bathroom in a Spa Room at Casa Palmero™.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Spa Rooms", tag: "Spa Room" },
      { src: "/images/pbc-portal/cp_2024_interior_sparoom_bathroom-1.jpg", alt: "Casa Palmero™ Spa Room bathroom interior, Pebble Beach, CA", caption: "Spa Room bathroom at Casa Palmero™ — The Spa Collection bath amenities throughout.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Spa Rooms", tag: "Spa Room" },
      { src: "/images/pbc-portal/cp_2024_interior_courtyardsuite.jpg", alt: "Casa Palmero™ Courtyard Suite interior, Pebble Beach, CA", caption: "A Courtyard Suite at Casa Palmero™ — private outdoor whirlpool spa in the courtyard garden.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Courtyard Suites", tag: "Courtyard Suite" },
      { src: "/images/pbc-portal/cp_2024_interior_courtyardsuite-1.jpg", alt: "Casa Palmero™ Courtyard Suite bedroom, Pebble Beach, CA", caption: "Courtyard Suite bedroom at Casa Palmero™ — wood-beamed ceilings and gas fireplace.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Courtyard Suites", tag: "Courtyard Suite" },
      { src: "/images/pbc-portal/cp_2024_interior_courtyardsuite-2.jpg", alt: "Casa Palmero™ Courtyard Suite living area, Pebble Beach, CA", caption: "Courtyard Suite living area at Casa Palmero™.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Courtyard Suites", tag: "Courtyard Suite" },
      { src: "/images/pbc-portal/cp_2024_interior_palmerosuite.jpg", alt: "Casa Palmero™ Palmero Suite living room with fireplace and private patio access, Pebble Beach, CA", caption: "The Palmero Suite at Casa Palmero™ — 1,500 sq ft opening onto the estate’s central courtyard.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Palmero Suite", tag: "Palmero Suite" },
      { src: "/images/pbc-portal/cp_2024_interior_palmerosuite-1.jpg", alt: "Casa Palmero™ Palmero Suite sitting room with kitchenette bar, Pebble Beach, CA", caption: "The Palmero Suite living room at Casa Palmero™ — the estate’s premier accommodation.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Palmero Suite", tag: "Palmero Suite" },
      { src: "/images/pbc-portal/cp_2024_interior_palmerosuite-2.jpg", alt: "Casa Palmero™ Palmero Suite king bedroom with private courtyard doors, Pebble Beach, CA", caption: "The Palmero Suite bedroom at Casa Palmero™.", credit: "Photo by Jamie Alcala", photographer: "Jamie Alcala", year: 2024, category: "Palmero Suite", tag: "Palmero Suite" },
