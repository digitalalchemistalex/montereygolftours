...
export const BLOG_POSTS: Record<string, BlogPost> = {
  ...
  "monterey-golf-first-time-guide": {
    ...
    { q: "What month is the AT&T Pebble Beach Pro-Am?", a: "The AT&T Pebble Beach Pro-Am typically takes place in late January or early February. During Pro-Am week, Pebble Beach Golf Links®, Spyglass Hill™, and Monterey Peninsula Country Club are closed to public play. Plan your trip around this event." },
    { q: "Do Monterey golf courses have a minimum group size?", a: "Most public courses welcome individual golfers and small groups with no minimum. Some premium courses and resort properties require minimum group sizes for preferred tee time blocks. Monterey Golf Tours negotiates group rates and preferred times regardless of group size." },
    { q: "Are Monterey Peninsula golf courses open to the public?", a: "Most peninsula courses are public or semi-private. Pebble Beach Golf Links®, Spyglass Hill™, and Del Monte™ are accessible to non-resort guests through advanced booking or an IAGTO Authorized Operator. Truly private clubs (Cypress Point, MPCC) are invitation-only." },
    { q: "How do I book Pebble Beach Golf Links® tee times without staying at the resort?", a: "Non-resort guests can book Pebble Beach Golf Links® tee times through the Pebble Beach Golf Reservations line (open 90 days in advance for non-guests) or through an IAGTO Authorized Pebble Beach Golf Travel Operator like Monterey Golf Tours, which can access tee times further in advance." },
    { q: "Is Bayonet Golf Course open to the public?", a: "Yes. Bayonet Golf Course is fully open to the public. No membership or resort stay is required. Tee times can be booked online or through Monterey Golf Tours as part of a planned peninsula trip." },
    { q: "What are the best budget hotels for a Monterey golf trip?", a: "Embassy Suites Monterey Bay - Seaside (steps from Bayonet and Black Horse), Monterey Beach Hotel (oceanfront in Sand City), and Casa Munras Garden Hotel offer the best value for golfers who want comfortable accommodations without resort pricing." },
    { q: "How long is Pacific Grove Golf Links?", a: "Pacific Grove Golf Links plays approximately 5,732 yards from the back tees (par 70). The shorter yardage makes it accessible for all skill levels, but coastal wind conditions can make it play much longer than the card suggests." },
    { q: "What is the weather like at Carmel Valley Ranch Golf Course?", a: "Carmel Valley Ranch Golf Club sits in a protected inland valley, typically 10-15°F warmer than coastal Monterey and almost always fog-free. The valley's microclimate makes it one of the most reliably sunny golf destinations on the peninsula." },
    { q: "Is lodging expensive during Monterey Car Week?", a: "Yes. Car Week is the most expensive week of the year in Monterey — hotel rates typically 2-3x normal. Book 6-12 months in advance for any lodging near the peninsula. Consider staying in Salinas or Seaside for more reasonable rates." },
    { q: "Where is Poppy Hills Golf Course located?", a: "Poppy Hills Golf Course is located in Pebble Beach at 3200 Lopez Road — within the Del Monte Forest, approximately 4 miles from Pebble Beach Golf Links®. It is adjacent to Spyglass Hill™ Golf Course." },
    { q: "Do Monterey golf courses have caddies?", a: "Yes. Pebble Beach Golf Links®, Spyglass Hill™, and Del Monte™ Golf Course all offer caddies. Rates vary from $65-80 per bag for a forecaddie to $130-160 for a full caddie. Many golfers consider a caddie at Pebble Beach an essential part of the experience." },
